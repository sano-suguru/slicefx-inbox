...
- ✅ **Fully generated typed client** (resolved in preview.7, [slicefx#5](https://github.com/sano-suguru/slicefx/issues/5)):
  All 8 handlers now return `SliceResult<T>` or `SliceResult` (non-generic). `SliceApiClient.g.cs`
  is fully generated by `slicefx client csharp`; the hand-written `SliceApiClient.cs` is removed.
